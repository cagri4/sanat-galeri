...
export default async function WhatsAppButton({ phone, artworkTitle, pageUrl, locale }: WhatsAppButtonProps) {
  const t = await getTranslations({ locale, namespace: 'gallery' })
  const href = buildWhatsAppHref(phone, artworkTitle, pageUrl)
